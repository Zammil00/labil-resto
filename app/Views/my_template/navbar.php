    ...
    <div class="container-fluid">
        <ul class="list-unstyled topnav-menu float-end mb-0">
            ...
            <li class="dropdown notification-list topbar-dropdown">
                <a class="nav-link dropdown-toggle position-relative" data-bs-toggle="dropdown" href="#" role="button"
                    ...
                    <div class="noti-scroll" data-simplebar>
                        ...
                        <a href="javascript:void(0);" class="dropdown-item notify-item border-bottom">
                            <div class="notify-icon">
                                <img src="<?=base_url('shreyu/assets/images/users/avatar-1.jpg')?>" class="img-fluid rounded-circle" alt="" />
                            </div>
                        ...
                        <a href="javascript:void(0);" class="dropdown-item notify-item border-bottom">
                            <div class="notify-icon">
                                <img src="<?=base_url('shreyu/assets/images/users/avatar-2.jpg')?>" class="img-fluid rounded-circle" alt="" />
                            </div>
            ...
            <li class="dropdown notification-list topbar-dropdown">
                <a class="nav-link dropdown-toggle nav-user me-0" data-bs-toggle="dropdown" href="#" role="button"
                    aria-haspopup="false" aria-expanded="false">
                    <img src="<?=base_url('shreyu/assets/images/users/avatar-1.jpg')?>" alt="user-image" class="rounded-circle">
        ...
        <div class="logo-box">
            <a href="index.html" class="logo logo-dark">
                <span class="logo-sm">
                    <img src="<?=base_url('shreyu/assets/images/logo-sm.png')?>" alt="" height="24">
                    <!-- <span class="logo-lg-text-light">Shreyu</span> -->
                </span>
                <span class="logo-lg">
                    <img src="<?=base_url('shreyu/assets/images/logo-dark.png')?>" alt="" height="24">
            ...
            <a href="index.html" class="logo logo-light">
                ...
                <span class="logo-lg">
                    <img src="<?=base_url('shreyu/assets/images/logo-light.png')?>" alt="" height="24">
                </span>
            </a>
        </div>
