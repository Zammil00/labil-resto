    ...
    <div class="h-100" data-simplebar>
        ...
        <div id="sidebar-menu">
            ...
            <ul id="side-menu">
                ...
                <li>
                    <a href="<?= site_url('chef/dashboard') ?>">
                        <i data-feather="home"></i>
                        <span> Dashboards Chef </span>
                    </a>
                </li>
                ...
                <li>
                    ...
                    <div class="collapse" id="sidebarPesanan">
                        <ul class="nav-second-level">
                            <li><a href="/chef/pesanan">Daftar Pesanan</a></li>
                            <!-- <li><a href="email-inbox.html">Proses</a></li> -->
                            <li><a href="<?= site_url('chef/pesanan/selesai') ?>">Selesai</a></li>
                        </ul>
                    </div>
                </li>
                ...
                <li>
                    <a href="#sidebarPembayaran" data-bs-toggle="collapse">
                        ...
                        <span> Menu Dan Bahan Baku </span>
                        <span class="menu-arrow"></span>
                    </a>
                    <div class="collapse" id="sidebarPembayaran">
                        <ul class="nav-second-level">
                            <li><a href="/chef/menu">Kelola Menu</a></li>
                            <li><a href="/chef/bahan">Kelola Bahan Baku</a></li>
                        </ul>
                    </div>
                </li>
